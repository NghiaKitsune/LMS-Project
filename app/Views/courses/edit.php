        ...
        <div class="card shadow border-0 mb-5">
            <div class="card-header bg-warning bg-opacity-25 border-bottom py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= BASE_URL ?>/course/my_courses" class="btn btn-sm btn-outline-dark">
            ...
            <div class="card-body p-4">
                ...
                <form action="<?= BASE_URL ?>/course/update/<?= $data['course']['id'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="<?= BASE_URL ?>/assets/uploads/<?= $data['course']['thumbnail'] ?>" 
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="<?= BASE_URL ?>/course/delete/<?= $data['course']['id'] ?>" 
